...
public class King extends ChessPiece {
    ...
    private void check_col_row(int col, int curCol, int row, int curRow) {
        ...
        if //VERTICAL 
            ...
            System.out.println("KING'S VERTICAL move is possible: OLD coordinates : (" + curRow + " , " + curCol + " )   NEW coordinates : ( " + row + " , " + col + " ) \n");
            setFirstMove(true);
            answer = true;
        }//HORIZONTAL 
        else if (row == curRow && ((col - curCol) == 1 || (col - curCol) == -1)) {   //if row(Xposition)is the same and newY - oldY = 1 or -1
            System.out.println("KING'S HORIZONTAL move is possible: OLD coordinates : (" + curRow + " , " + curCol + " )   NEW coordinates : ( " + row + " , " + col + " ) \n");
            setFirstMove(true);
            answer = true;
        }//DIAGONAL 
        else if ((((row - curRow) == 1 || (row - curRow) == -1) && ((col - curCol) == 1 || (col - curCol) == -1))) {    //newX - oldX = 1 or -1 AND newY - oldY = 1 or -1
            System.out.println("KING'S DIAGONAL  move is possible: OLD coordinates : (" + curRow + " , " + curCol + " )   NEW coordinates : ( " + row + " , " + col + " ) \n");
            setFirstMove(true);
            answer = true;
        } else {
        ...
        if (startTile.getChessPiece().firstMove() && endTile.getChessPiece().firstMove()) {
            if ("b".equals(rook_color) && "b".equals(king_color)) { //black  colour
                ...
                if (king_curRow == 0 && king_curCol == 4 && rook_curRow == 0 && rook_curCol == 7 && (!board.isFieldOccupied(0, 5)) && (!board.isFieldOccupied(0, 6))) {                    //*if they are in their initial position  ++ the in-between fields empty : [0][5]  [0][6]
                    System.out.println("CASTLING:Possible: same color=b, king_curRow == 0 && king_curCol == 4 && rook_curRow == 0 && rook_curCol == 7 ");
                    possible = true;
                    ...
                    System.out.println("CASTLING:Possible: same color=b, king( Row == 0 , Col == 4 ) && rook ( Row == 0 && Col == 0)");
                    possible = true;
                } else {
                    possible = false;
                }
                ...
                if (king_curRow == 7 && king_curCol == 4 && rook_curRow == 7 && rook_curCol == 7 && (!board.isFieldOccupied(7, 5)) && (!board.isFieldOccupied(7, 6))) {   //[7][5]  [7][6]: must be empty 
                    System.out.println("CASTLING:Possible: same color=w, king_curRow == 7 && king_curCol == 4 &&  rook_curRow == 7 && rook_curCol == 7 && empty: [7][5]  [7][6]");
                    possible = true;
                    ...
                    System.out.println("CASTLING:Possible: same color=w, king_curRow == 7 && king_curCol == 4 && rook_curRow == 7 && rook_curCol == 0 + empty: [7][1],  [7][2], [7][3]");
                    possible = true;
                } else {
                    possible = false;
                }
